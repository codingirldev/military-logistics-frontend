...
export default function CheckpointTable({ crateId, trackId }: CheckpointTableProps) {
  ...
  const getStatusBadge = (checkpoint: Checkpoint) => {
    ...
    if (checkpoint.verified) {
      return (
        <span className="inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-semibold bg-green-900/30 text-green-400 border border-green-700">
    ...
    <div className="bg-gray-900 border border-gray-700 rounded-lg p-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          className="px-4 py-2 bg-gray-800 hover:bg-gray-750 border border-gray-700 rounded text-white text-sm transition-colors"
        >
          Refresh
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full bg-gray-800 border border-gray-700 rounded px-10 py-2 text-white placeholder-gray-500 focus:outline-none focus:border-green-500 transition-colors"
          />
        </div>
        ...
        <select
          ...
          className="bg-gray-800 border border-gray-700 rounded px-4 py-2 text-white focus:outline-none focus:border-green-500 transition-colors"
        >
